...
//        }        
    ...
    private function get_debug_info()
    {
        ...
        $debug_html .= (isset($this->_debug_log['data_start_time']) && isset($this->_debug_log['data_end_time'])) ? '<li class="list-group-item ">Data Retrival Time: <span class="label label-info">'.sprintf('%f', number_format((float)$this->_debug_log['data_end_time'] - (float)$this->_debug_log['data_start_time'], 6)).'</span> sec.</li>' : '';
        $debug_html .= (isset($this->_debug_log['render_start_time']) && isset($this->_debug_log['render_end_time'])) ? '<li class="list-group-item ">Grid Render Time: <span class="label label-info">'.sprintf('%f', number_format((float)$this->_debug_log['render_end_time'] - (float)$this->_debug_log['render_start_time'], 6)).'</span> sec.</li>' : '';
        $debug_html .= (isset($this->_debug_log['grid_start_time']) && isset($this->_debug_log['grid_end_time'])) ? '<li class="list-group-item ">Total Time: <span class="label label-info">'.sprintf('%f', number_format((float)$this->_debug_log['grid_end_time'] - (float)$this->_debug_log['grid_start_time'], 6)).'</span> sec.</li>' : '';
        $debug_html .= '</ul>';
        $debug_html .= '</div></div>'; 
        return $debug_html;
    }
    ...
    function get_microtime_formated($microtime)
    {
        ...
        return date('H:i:s', $sec) . number_format($usec, 6);
    }
}